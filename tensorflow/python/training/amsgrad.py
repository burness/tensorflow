...
class AMSGradOptimizer(optimizer.Optimizer):
  ...
  def __init__(self, learning_rate=0.001, beta1=0.9, beta2=0.999,
               epsilon=1e-8, use_locking=False, name="AMSGradOptimizer"):
  ...
  def _apply_dense(self, grad, var):
    ...
    return training_ops.apply_amsgrad(
        var, m, v,
  ...
  def _resource_apply_dense(self, grad, var):
    m = self.get_slot(var, "m")
    v = self.get_slot(var, "v")
    return training_ops.resource_apply_amsgrad(
  ...
  def _apply_sparse_shared(self, grad, var, indices, scatter_add):
    ...
    v_t = math_ops.maximum(v_t, v_last_step)
